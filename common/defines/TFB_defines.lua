...
NDefines.NGame.GAME_SPEED_SECONDS = { 99999.0, 0.26, 0.22, 0.08, 0.0 } -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDefines.NDiplomacy.ASSUME_FACTION_SPYMASTER_COOLDOWN_DAYS = 0 --was 180 -- Number of days after change of Spy Master before another country is allowed to become Spy Master.
...
NDefines.NCountry.SPECIAL_FORCES_CAP_MIN = 10000000 --28					-- You can have a minimum of this many special forces battalions regardless of the number of non-special forces battalions you have this can also be modified by a country modifier
NDefines.NCountry.BASE_FUEL_GAIN = 2.0				-- 	base amount of fuel gained hourly, independent of excess oil
NDefines.NCountry.BASE_FUEL_GAIN_PER_OIL = 0.15 --0.2						-- base amount of fuel gained hourly per excess oil
...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.016 --0.02 --0.03 --0.04        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
NDefines.NMilitary.LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.03 --0.05        -- global damage modifier
NDefines.NMilitary.LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 6
NDefines.NMilitary.LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.0225 --0.03    -- air global damage modifier
NDefines.NMilitary.LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.0225 --0.03    -- global damage modifier
...
NDefines.NMilitary.ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.7 --0.07 -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
...
NDefines.NMilitary.FIELD_EXPERIENCE_SCALE = 0.003 -- xp in combat maybe 50% more 0.002 before
...
NDefines.NMilitary.NAVAL_EQUIPMENT_BASE_COST = 1 --Cost in XP to upgrade a piece of equipment one level is base + ( total levels * ramp )
...
NDefines.NAir.AIR_WING_XP_TRAINING_MISSION_GAIN_DAILY = 7.0
NDefines.NAir.AIR_WING_MAX_STATS_ATTACK = 300
...
NDefines.NAir.DISRUPTION_FACTOR = 4  -- with decent radar coverage equal amounts of fighters vs naval bombers will disrupt almost all naval bombers if not escorted, with low detection very few bombers are intercepted still
NDefines.NAir.ESCORT_FACTOR = 5 --3.5 -- 4  		--to make sure that escorted planes are still capable of bombing, with equal escorts/interceptors most of bombers get through Keep in mind that these values will also affect how cas/tac/strat bombers work, they make escorting planes much more important (which imo is 100% fine)
...
-- conversion speed
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN = 7 --10			-- railways will be put on cooldown when they are captured by enemy and will not be usable during the cooldown
NDefines.NSupply.RAILWAY_CONVERSION_COOLDOWN_CORE = 4 --5
